...
def test_built_wheel_imports_from_clean_directory(tmp_path):
    ...
    for name in ['pyproject.toml','train_r7_local.py','evaluate_r7_local.py']:
    ...
    with zipfile.ZipFile(wheel) as z:
        ...
        assert 'train_r7_local.py' in names and 'evaluate_r7_local.py' in names
