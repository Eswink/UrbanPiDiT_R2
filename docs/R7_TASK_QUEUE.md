...
on 2026-09-25 all eight issues were closed on GitHub through the single
authorized fast-forward of the closing commit (this one) to `main` — no merge
commit, no force, no release, no paid GPU, no uncontrolled data mirror.
Experimental workflows stay tag-gated and skipped on this push by design.
